...
- Sorting: Quicksort, Insertion Sort, Bubble Sort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Breadth-first search, depth-first search, Dijkstra, Prim MST, Knuth-Morris-Pratt, and Levenshtein Distance are live.

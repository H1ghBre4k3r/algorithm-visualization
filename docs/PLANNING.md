...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Cocktail Shaker Sort, Odd-Even Sort, Pancake Sort, Quickselect, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Timsort, Heap Sort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Cocktail Shaker Sort, Odd-Even Sort, Pancake Sort, Quickselect, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Timsort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.

...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Mergesort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Mergesort, Breadth-first search, depth-first search, Dijkstra, Prim MST, Knuth-Morris-Pratt, and Levenshtein Distance are live.

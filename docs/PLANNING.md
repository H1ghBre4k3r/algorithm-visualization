...
- Graph: Breadth-first search, depth-first search, Dijkstra, Prim MST, Kruskal.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Mergesort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.

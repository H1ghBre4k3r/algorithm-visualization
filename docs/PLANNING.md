...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Shell Sort, Mergesort, Heap Sort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Shell Sort, Mergesort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.

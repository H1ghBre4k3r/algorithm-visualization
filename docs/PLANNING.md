...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Cocktail Shaker Sort, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Timsort, Heap Sort.
- Graph: Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Cocktail Shaker Sort, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Timsort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.

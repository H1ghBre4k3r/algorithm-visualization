...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Cocktail Shaker Sort, Odd-Even Sort, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Timsort, Heap Sort.

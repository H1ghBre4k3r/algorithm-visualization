...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Mergesort, Heap Sort.
...
2. Expand sorting.
   - Add shell sort, counting sort, and radix sort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Mergesort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.

...
- Sorting: Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Heap Sort.
...
2. Expand sorting.
   - Add cocktail shaker sort and timsort.
...
- Only Quicksort, Insertion Sort, Bubble Sort, Selection Sort, Shell Sort, Counting Sort, Radix Sort, Bucket Sort, Comb Sort, Mergesort, Heap Sort, Breadth-first search, depth-first search, Dijkstra, Bellman-Ford, A*, Prim MST, Kruskal, Knuth-Morris-Pratt, and Levenshtein Distance are live.
